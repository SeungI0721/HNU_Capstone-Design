...
object FakeSensorDataProvider {
    ...
    private val samples = listOf(
        ...
        "ID:0001,TEMP:37.6,HR:95,SPO2:96,ENV:31.5,HUM:55,LUX:8000,AX:0.42,AY:0.18,AZ:9.62,POSTURE:NORMAL",
        "ID:0001,TEMP:38.0,HR:118,SPO2:96,ENV:33.2,HUM:65,LUX:20000,AX:2.20,AY:1.10,AZ:9.12,POSTURE:NORMAL",
